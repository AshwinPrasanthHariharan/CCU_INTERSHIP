...
* **Day 2 (May 19):** Foundational Understanding of The algorithm
    - **Objectives**
        ...
        3. **Domain Transform Orchestration (ISFFT):** Execute the 2D "matrix transform sandwich" $(\mathbf{W}_M\u22cdot D\u22cdot\mathbf{W}_N^{\u22121})$ to rotate abstract environmental coordinates into standard multi-carrier Time-Frequency coordinates $(\mathbf{X}_{TF})$.
